...
const TAB_NAMES: { key: TabName; label: string; icon: string }[] = [
  { key: 'hotels', label: 'Hotels', icon: 'home' },
  { key: 'dayplan', label: 'Day Plan', icon: 'map' },
...
export default function TripDetails() {
    ...
    return (
      <SafeAreaView className="flex-1 bg-background dark:bg-background-dark">
        <View className="flex-row items-center px-6 pt-4 pb-4">
          ...
          <Text className="text-xl font-bold text-text dark:text-text-dark">Trip Details</Text>
        </View>
        <View className="items-center justify-center flex-1 px-6">
          ...
          <Text className="mt-4 text-lg font-semibold text-center text-text dark:text-text-dark">
            {isForbidden ? 'Access Denied' : 'Trip Not Found'}
          </Text>
  ...
  if (!currentTrip) {
    return (
      <SafeAreaView className="items-center justify-center flex-1 bg-background dark:bg-background-dark">
        <Text className="text-muted dark:text-muted-dark">Trip not found</Text>
      </SafeAreaView>
    );
  }
